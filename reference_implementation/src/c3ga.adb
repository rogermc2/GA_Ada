...
package body C3GA is
   ...
   no_BV : constant Multivector.Multivector := Multivector.Get_Basis_Vector (Blade.no);
   e1_BV : constant Multivector.Multivector := Multivector.Get_Basis_Vector (Blade.e1);
   e2_BV : constant Multivector.Multivector := Multivector.Get_Basis_Vector (Blade.e2);
