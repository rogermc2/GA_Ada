...
--                              Model_View_Matrix, Point_Position, Palet_Data);
         ...
         if not Pick_Manager.Pick_Active then
            ...
            GA_Utilities.Print_Multivector ("Display, aLine OP:", aLine);
            --  aLine OP values agree with values generated by C++ program
            aLine := Multivectors.Outer_Product (aLine, C3GA.ni);
            GA_Utilities.Print_Multivector ("Display, aLine OP C3GA.ni:", aLine);
            --  aLine OP C3GA.ni values agree with values generated by C++ program
            aLine := Multivectors.Unit_R (aLine, Metric.C3_Eigen_Matrix);
            GA_Utilities.Print_Multivector ("Display, aLine Unit_R:", aLine);
