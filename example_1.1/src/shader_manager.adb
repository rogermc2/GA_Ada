...
package body Shader_Manager is
   ...
   Pick_Uniforms   :Pick_Uniforms_IDs;
   ...
   begin
      ...
      Pick_Uniforms.MVP_Matrix_ID :=
        Uniform_Location (Render_Program, "MVP");
      Pick_Uniforms.Pick_Colour_ID :=
        Uniform_Location (Render_Program, "colour");
      ...
      GL.Uniforms.Set_Single (Pick_Uniforms.MVP_Matrix_ID, Identity4);
      GL.Uniforms.Set_Single (Pick_Uniforms.Pick_Colour_ID, Black);
   ...
   procedure Set_Pick_Colour (Pick_Colour : Singles.Vector4) is
   begin
      GL.Uniforms.Set_Single (Pick_Uniforms.Pick_Colour_ID, Pick_Colour);
   end Set_Pick_Colour;

   --  -------------------------------------------------------------------------

   procedure Set_Pick_Matrix (Pick_Matrix : Singles.Matrix4) is
   begin
      GL.Uniforms.Set_Single (Pick_Uniforms.MVP_Matrix_ID, Pick_Matrix);
   end Set_Pick_Matrix;
