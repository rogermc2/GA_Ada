...
private
   ...
   for C3_Base use
     (C3_no => 0, C3_e1 => 1, C3_e2 => 2, C3_e3 => 4, C3_ni => 8,
      C3_e1_e2 => 2 ** 4, C3_e1_e3 => 2 ** 5, C3_e2_e3 => 2 ** 6,
      C3_e1_no => 2 ** 7, C3_e2_no => 2 ** 8, C3_e3_no => 2 ** 9,
      C3_e1_ni => 2 ** 10, C3_e2_ni => 2 ** 11, C3_e3_ni => 2 ** 12,
      C3_e1_e2_e3 => 2 ** 13, C3_e1_e2_no => 2 ** 14, C3_e1_e2_ni => 2 ** 15,
      C3_e1_e3_no => 2 ** 16, C3_e1_e3_ni => 2 ** 17,
      C3_e2_e3_no => 2 ** 18, C3_e2_e3_ni => 2 ** 19,
      C3_e1_no_ni => 2 ** 20, C3_e2_no_ni => 2 ** 21, C3_e3_no_ni => 2 ** 22,
      C3_e1_e2_e3_ni => 2 ** 23, C3_e1_e2_e3_no => 2 ** 24,
      C3_e1_e2_no_ni => 2 ** 25, C3_e1_e3_no_ni => 2 ** 26,
      C3_e2_e3_no_ni => 2 ** 27, C3_e1_e2_e3_no_ni => 2 ** 28);
