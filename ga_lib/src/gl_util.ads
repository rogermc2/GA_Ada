...
package GL_Util is
   ...
   procedure Rotor_GL_Multiply (R : Multivectors.Rotor; GL_Matrix : in out GL.Types.Singles.Matrix4);
   function To_GL (V3 : Multivectors.Vector) return GL.Types.Doubles.Vector3;
   function To_GL (V3 : Multivectors.Vector) return GL.Types.Singles.Vector3;
--     function To_GL (V2 : Multivectors.Vector) return GL.Types.Singles.Vector3;
